...
def test_should_label_stackoverflow_questions():
    # Given:
    ...
    # Then:
    assert_that(label) \
        .is_equal_to('SO#74206388')


def test_should_label_stackoverflow_answers():
    # Given:
    ...
    # Then:
    assert_that(label) \
        .is_equal_to('SO#470376')


def test_should_label_network_questions():
    # Given:
    ...
    # Then:
    assert_that(label) \
        .is_equal_to('cs.SE#45486')


def test_should_label_network_answers():
    # Given:
    url = "https://cs.stackexchange.com/questions/45486/" \
